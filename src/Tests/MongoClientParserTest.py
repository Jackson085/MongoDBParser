...
class MongoClientParserTest(unittest.TestCase):
    ...
    def test_dict_with_subclass_to_object(self):
        ...
        loaded_class = self.ins._parse_result_to_object(json, ClassWithSubclass, {'sub_class': SimpleClass})
    ...
    def test_dict_with_two_subclass_to_object(self):
        ...
        loaded_class = self.ins._parse_result_to_object(json, ClassWithTwoSubclasses, {'child_class': ClassWithSubclass}, {'sub_class': SimpleClass})
    ...
    def test_object_with_list_to_dict(self):
        ...
        loaded_class = self.ins._parse_result_to_object(json, ClassWith2DList)
    ...
    def test_dict_with_list_of_dict_to_object(self):
        ...
        loaded_class = self.ins._parse_result_to_object(json, ClassWithObjectsInList, {'SimpleClass': SimpleClass})

        # self.assertIsInstance(loaded_class, ClassWithObjectsInList)
